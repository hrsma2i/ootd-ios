...
struct GuProductDetail: Codable {
    ...
    func categoryPath() -> [String] {
        return [
            result.breadcrumbs.class_.locale,
            result.breadcrumbs.category.locale,
            result.breadcrumbs.subcategory.locale,
        ]
    }
    
    var description: String {
        return result.longDescription.replacingOccurrences(of: "<br>", with: "\n")
    }
}
